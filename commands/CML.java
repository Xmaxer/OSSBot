...
public class CML extends Command{
	...
	private void updateCML() {
		...
		int response = Integer.valueOf(BotFiles.getLinkData(OssBotConstants.CML_UPDATE_LINK + name).replace("ï»¿", ""));
		String output = "";
		switch(response)
		{
		case 1:
	...
	private void getCMLXP(String skill,String number, String playerName, String interval) {
		...
		String xpData = BotFiles.getLinkData(OssBotConstants.CML_TRACKING_LINK + playerName + "&time=" + timeInterval).replace("ï»¿", "");
		String output = "";
